<script lang="ts">
	let skills = {
		...
		frameworks: ['Svelte Kit', 'Lynx', 'React'],
		toolsAndLibraries: {
			frontEnd: ['Tailwind CSS', 'Bootstrap', 'Daisy UI', 'Threlte', 'Three JS'],
			backEnd: ['Supabase', 'Firebase', 'Neon DB', 'SQL', 'PostgreSQL', 'Docker', 'Auth0', 'groq'],
